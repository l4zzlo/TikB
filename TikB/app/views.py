...
from .models import Contact, ContactGroup, Gender, Queue, Production
...
class Production(ModelView):
    datamodel = SQLAInterface(Production)
...
appbuilder.add_separator("Devices")
